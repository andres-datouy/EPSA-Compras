...
$schema = @{
    ...
    "factRecepcionesHistoria" = @("Compra Empresa","RecepcionFecha","RecepcionArticulo","RecepcionCantidad","RecepcionOCDocumento","RecepcionOCNumero","OC Documento","OC Numero","OC Proveedor","OC Fecha","OC Total MO","OC Total TR","OC Moneda","OC Articulo Codigo","OC PrecioMO","OC PrecioUSD","SolicitudDocumento","SolicitudNumero","SolicitudFecha","Compra Documento","Compra Numero","Compra Fecha","Compra OC Doc","Compra OC Numero","Compra Fecha Inicio Proceso","Lead Time Dias")
